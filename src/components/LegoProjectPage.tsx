  ...
  return (
    <div className='TextPage'>
      ...
      <p className='TextContents'>In the lego project, we had to use a lego mindstorm ev3 robot to do 4 seperate warm-up tasks, and one final project. The robot was coded in python using micropython and pybricks.
        ...
        <br /><br />The project files for the warm-up tasks are available in our git <a href='https://git.ntnu.no/Team-3/Innledende-Lego-oppgaver'>repository</a>, and our final project is likewise available at our git <a href='https://git.ntnu.no/Team-3/Medisinrobot'>repository</a></p>
